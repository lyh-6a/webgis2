    ...
    <div id="app">
        <el-container class="app-out-pannel">
            ...
            <el-container class="app-content-pannel">
                ...
                <el-dialog title="用户登录/注册" :visible.sync="loginDialogVisible"  width="30%" :show-close=false :close-on-click-modal=false :close-on-press-escape=false >
            ...
            if (!_self.loginSwitch) {
                ...
                axios
                    ...
                    .catch(function (error) {
                        _self.loginDialogVisible = true;
                         _self.$message.error('登陆失败，用户名错误');
                        console.log(error);
                    });
            } else {
                //用户注册
